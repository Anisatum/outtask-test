...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
                        ...
                        <div class="flex flex-row p-6">
                            <div class="ml-12">
                                <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                    <span id="APIResult">API messages will appear here</span>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        const syncAPIButton = document.querySelector("#syncAPI");
        const deleteEmployeesButton = document.querySelector("#deleteEmployees");
        const apiMSGs = document.querySelector("#APIResult");
        ...
        function syncAPI() {
            ...
            xhr.onload = () => {
                if (xhr.readyState === 4 && xhr.status === 200 && xhr.response) {
                    apiMSGs.innerHTML = xhr.response.msg;
                } else {
                    apiMSGs.innerHTML = "Request failed";
                }
            };
        }
        ...
        syncAPIButton.addEventListener("click", syncAPI);
        deleteEmployeesButton.addEventListener("click", deleteEmployees);
    </script>
    </body>
</html>
